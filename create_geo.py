...
parser.add_argument('--ly_in', dest='ly_in', default=1.0, help='Input wg Y length', type=float)
...
parser.add_argument('--ly_out', dest='ly_out', default=1.0, help='Output wg Y length', type=float)
